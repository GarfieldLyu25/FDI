...
class powerGridPWMapMgr(object):
    ...
    def _initMotors(self):
        parm = [
            {'id': 'Motor-1',
             ...
             'pwrstate': gv.gItemStateDict['Motor1'] if gv.gItemStateDict else 1,
             'swstate': gv.gItemStateDict['Motor1SW'] if gv.gItemStateDict else 1
             },
            {'id': 'Motor-2',
             'type': 'Moto-Pump',
             ...
             'pwrstate': gv.gItemStateDict['Motor2'] if gv.gItemStateDict else 1,
             'swstate': gv.gItemStateDict['Motor2SW'] if gv.gItemStateDict else 1
             },
            ...
            {'id': 'Motor-3',
             ...
             'pwrstate': gv.gItemStateDict['Motor3'] if gv.gItemStateDict else 1,
             'swstate': gv.gItemStateDict['Motor3SW'] if gv.gItemStateDict else 1
             }
        ]
        for m in parm:
    ...
    def _initGenerators(self):
        parm = [
            {'id': 'Gen-1',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['Gen1SW'] if gv.gItemStateDict else 1,
            ...
            {'id': 'Gen-2',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['Gen2SW'] if gv.gItemStateDict else 1,
             'powerparm':(10, 400, ('kV', 'A')),
            ...
            {'id': 'Gen-3',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['Gen3SW'] if gv.gItemStateDict else 1,
             'powerparm':(10, 400, ('kV', 'A')),
    ...
    def _initSolarPanel(self):
        parm = {'id': 'Solar-Panels',
                ...
                'swstate': gv.gItemStateDict['SolarSW'] if gv.gItemStateDict else 1,
    ...
    def _initWindTurbine(self):
        parm = {'id': 'Wind-Tubines',
                ...
                'swstate': gv.gItemStateDict['WindSW'] if gv.gItemStateDict else 1,
    ...
    def _initUpTF(self):
        parm = [
            {'id': 'Transformer-01',
             ...
             'pwrstate': 0,
             'swstate': gv.gItemStateDict['SolarTrans'] if gv.gItemStateDict else 1,
            ...
            {'id': 'Transformer-02',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['WindTrans'] if gv.gItemStateDict else 1,
             'powerparm':(33, 100, ('kV', 'A')),
            ...
            {'id': 'Transformer-03',
             ...
             'pwrstate': 0,
             'swstate': gv.gItemStateDict['GenTrans'] if gv.gItemStateDict else 1,
    ...
    def _initSubST(self):
        parm = {'id': 'Substation',
                ...
                'pwrstate': 1,
                'swstate': gv.gItemStateDict['TransmitIn'] if gv.gItemStateDict else 1,
    ...
    def _initDownTF(self):
        parm = [
            {'id': 'Lvl0-transformer',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['DownTrans1'] if gv.gItemStateDict else 1,
            ...
            {'id': 'Lvl2-transformer',
             ...
             'pwrstate': 1,
             'swstate': gv.gItemStateDict['DownTrans3'] if gv.gItemStateDict else 1,
    ...
    def _initRailway(self):
        ...
        self.loadRailway = agent.AgentLoad(self, parm['id'], parm['pos'],
                                             parm['tgtpos'], parm['type'])
        ...
        self.loadRailway.setPowerParm(
            parm['powerparm'][0], parm['powerparm'][1], parm['powerparm'][2])
        # self.loadRailway.setEnergyFlowPt(parm['enegyPts'])
    ...
    def _initFactory(self):
        ...
        self.loadFactory = agent.AgentLoad(self, parm['id'], parm['pos'],
                                            parm['tgtpos'], parm['type'])
    ...
    def _initHome(self):
        parm = {
            ...
            'tgtpos': None,
            'pwrstate': 1,
            'swstate': gv.gItemStateDict['Load3'] if gv.gItemStateDict else 1,
            'powerparm': (220, 40, ('V', 'A'))
        }
        self.loadHome = agent.AgentLoad(self, parm['id'],parm['pos'],
                                          parm['tgtpos'], parm['type'])
        self.loadHome.setPowerState(parm['pwrstate'])
        self.loadHome.setSwitchState(parm['swstate'])
        self.loadHome.setName(parm['name'])
        self.loadHome.setPowerParm(
            parm['powerparm'][0], parm['powerparm'][1], parm['powerparm'][2])
    ...
    def updateComponentsData(self):
        ...
        self.loadRailway.updateDataDict()
        self.loadFactory.updateDataDict()
        self.loadHome.updateDataDict()
